            ...
            <Row className="g-1 justify-content-center">
              {products.length === 1 ? (
                <Col xs={12} sm={6} md={4} lg={3} className="d-flex justify-content-center">
                  <Card className="product-card h-100 border-0" onClick={() => handleProductClick(products[0])}>
                ...
                products.slice(0, 4).map((product) => (
                  <Col xs={12} sm={6} md={4} lg={2} key={product.id} className="d-flex justify-content-center">
